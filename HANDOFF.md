...
先读当前目录 submission/START_HERE_zh.md 和 FILE_INDEX.md。submission/liu.pdf 为投稿文件命名副本，但利益冲突声明尚待作者确认，另有三位作者 ORCID 缺失；ready_to_submit=false。原实验和统计结果不变。新版 Figure 1 用 TikZ 重绘，Figure 2 标签至少 9pt。第 5 页包含伦理和 AI 辅助说明。已移除 MGA-CLIP 与 Contrastive Concept Importance 两条未能直接核验的外围引用。当前共 13 条引用，不宣称全部出版元数据均已独立核实。
