...
Source lineage: Round-6 at d574378f345b301a322051edb191e55fea91c68b. All statistical inputs and manuscript table rows are unchanged. See inherited evidence_checks.json and robustness_checks.json for source hashes and descriptive-analysis scope. No new model inference, masks or confidence intervals.

Current official pages consulted 2026-09-15:
...
The PDF build checks five pages, correct reference placement, embedded/subset fonts, no Type 3 fonts or overfull boxes, and independently compiled source/arXiv rendering equivalence. Figure 1 is based on Round-6 with only masking terminology corrected at the user’s request; Figure 2 labels use at least 9pt; mathematical subscripts retain conventional smaller sizes. Visual review is recorded separately. Existing compatible custom layout is retained; this is not certification by the conference checker.
...
Required author metadata/declarations remain incomplete. Submission metadata explicitly records ready_to_submit=false. No rights-transfer form or absence-of-conflict statement is signed or asserted on behalf of authors.
