...
authors=[]
for n,e,a,addr,oid,corr in [('Kaixin Liu','24107880127@nustti.edu.cn',aff1,a1,'',False),('Zhipeng Ye','zhipengye@nustti.edu.cn',aff1,a1,'',True),('Feng Jiang','jf@nustti.edu.cn',aff1,a1,'',False),('Qiufeng Wang','qiufeng.wang@xjtlu.edu.cn',aff2,a2,'',False),('Qihang Wu','24107880128@nustti.edu.cn',aff1,a1,'https://orcid.org/0009-0009-6082-0223',False),('Xihang Zhou','xihang.zhou@mail.utoronto.ca',aff3,a3,'',False)]:
...
metadata=dict(title=title,abstract=abstract,abstract_word_count=len(abstract.split()),keywords=keywords.split(', '),authors=authors,ready_to_submit=False,pending=['ORCID URLs for the five authors other than Qihang Wu','Author-confirmed funding and conflicts-of-interest statement to insert on page 5','Author confirmation of ethical-compliance and AI-assistance statements; final author approval'],review_category=None)
