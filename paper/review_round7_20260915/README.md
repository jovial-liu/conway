...
Start with `submission/START_HERE_zh.md`. Current PDF: `submission/liu.pdf`, identical to `generated/ccf0_round7_20260915.pdf`. Author information is incomplete for submission: five ORCIDs and the funding/conflicts statement must still be supplied. No submission has been made.
