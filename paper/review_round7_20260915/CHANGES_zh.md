...
第 3 项已完成：NeurIPS 2022 Wang & Wang 第 3.3 节及引用已核对、补入创新边界。第 1 项固定原 A 的归一化分析脚本已准备，第 2 项同批记录采集与核验脚本已准备；合成验证通过，但缺本机张量/模型运行条件，真实结果尚未生成。详见 priority123/README_zh.md。
